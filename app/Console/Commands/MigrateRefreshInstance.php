...
class MigrateRefreshInstance extends Command
{
  /**
   ...
   * @var string
   */
    protected $signature = 'lmt:migrate:refresh {name} {--test}';
   ...
   * @var string
   */
    protected $description = 'Refresh migrations on a specified Instance.';
   ...
   */
    public function handle()
    {
        ...
        if (! $this->option('test')) {
            $migration = InstanceSetup::migrate($instance, 'refresh');
